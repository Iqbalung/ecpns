<script src="<?php echo e(JS); ?>bootstrap-toggle.min.js">

</script>

<script src="<?php echo e(JS); ?>jquery.flexslider.js"></script>
...
app.controller('angExamScript', function($scope, $http) {
...

    {
        ...
        route = '<?php echo e(URL_BOOKMARK_SAVED_BOOKMARKS); ?>';
...

    {
        ...
        route = '<?php echo e(URL_BOOKMARK_ADD); ?>';
        ...
        if(operation=='delete') {
          ...
          route = '<?php echo e(URL_BOOKMARK_DELETE); ?>'+item_id;
