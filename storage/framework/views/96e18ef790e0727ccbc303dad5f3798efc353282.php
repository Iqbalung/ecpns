...
<style>
  .hhbimg{
    background: url(<?php echo e(IMAGE_PATH_SETTINGS.$home_back_image); ?>) center center no-repeat;
  }
  .hhfr{
    float:right;
  }
                              ...
                              <ul class="cs-card-actions mt-0">
                                ...
                                <div class="text-center mt-2">
                                    ...
                                    <?php if( $quiz->is_paid == 1): ?>
                                      ...
                                      <a href="#" class="hhfr"><?php echo e(getPhrase('price')); ?> : <?php echo e(getCurrencyCode()); ?> <?php echo e((int)$quiz->cost); ?>
                          ...
                          <div class="info-box ribbon_box same_height">
                           ...
                           <li>  <a href="<?php echo e(URL_VIEW_LMS_CONTENTS.$series->slug); ?>" class="cs-product-title"><?php echo e(ucfirst($series->title)); ?></a></li>
                              ...
                              <?php if($series->is_paid): ?>
                                      ...
                                      <li><a href="#" class="hhfr"><?php echo e(getPhrase('price')); ?> : <?php echo e(getCurrencyCode()); ?> <?php echo e((int)$series->cost); ?>
