        ...
        <div class="cs-topbar">
            <div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo e(URL_HOME); ?>"><img src="<?php echo e(IMAGE_PATH_SETTINGS.getSetting('site_logo', 'site_settings')); ?>" alt="logo" class="cs-logo" class="img-responsive nh-hei"></a>
                </div>
                ...
                <ul class="nav navbar-nav navbar-right nv-mt" >
                    ...
                    <li><a href="https://codecanyon.net/item/menorahoes-online-learning-and-examination-system/19361996" class="cs-nav-btn visible-lg yellow-buy brbc"> <?php echo e(getPhrase('Buy_Now')); ?></a></li>
                    <?php endif; ?>
