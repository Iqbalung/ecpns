...
font-size: 20px;
    ...
    <?php 
        ...
        //$base .= '://'.isset(isset($_SERVER['HTTP_HOST'])?isset($_SERVER['HTTP_HOST'])?isset($_SERVER['HTTP_HOST'])?isset($_SERVER['HTTP_HOST'])?$_SERVER['HTTP_HOST']:"localhost:8000/":"localhost:8000/":"localhost:8000/":"localhost:8000/")?$_SERVER['HTTP_HOST']:"localhost:8000/".'/'.$path[1].'/';
