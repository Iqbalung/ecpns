...
.cf-headone{
  line-height: initial;vertical-align: -webkit-baseline-middle;
}
.cf-span-headone{
right: 70%;left: auto !important;
}
.cf-time{
  color:#fff !important;
}
    ...
    <div class="container-fluid cf-main">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-custom custom-panel">
                    ...
                    <div class="panel-heading heading-panel cf-head" >
                        ...
                        <h1 class="cf-headone">
                            ...
                            <span class="text-uppercase title-heading cf-span-headone">
                             ...
                             <?php $section_data  = (array)json_decode($quiz->section_data); ?>
                              ...
                              @foreach($section_data as $key=>$value)
                                ...
                                <span id="{{$key}}" class="question-sections margin_right">
        ...
        <div id="timerdiv" class="countdown-styled timer-style">
          <span class="remaining">
            <i class="mdi mdi-timer timercss"></i>
          Time Remaining For This Section
           </span>

            <span id="hours" class="cf-time">{{ $time_hours}}</span> :
            <span id="mins" class="cf-time">{{ $time_minutes}}</span> :
            <span id="seconds" class="cf-time">00</span>
...
<!--   <i class="mdi mdi-printer"></i>  -->
  {{getPhrase('question')}}
                    ...
                    <div class="flag-details" >
                     ...
                     <span class="positive next review-next markbtncss" id="markbtn" type="button">
                      ...
                      Flag for Review
                        ...
                        <?php
                         ...
                         ?>
                            ...
                            data-acid="subject_section_{{$key}}"
                            data-reviewid="{{$key}}"
                            ...
                            <div class="row max ">
                                ...
                                <div class="col-md-12">
                                   ...
                                   <button class="btn btn-lg btn-info button success-btn next" type="button" >
                                       ...
                                       <i class="fa fa-arrow-right arrow-right-css"></i>
                                    </button>
                                    ...
                                    <button class="btn btn-lg btn-info button paranext nextpara para-next" type="button" >
                                       ...
                                       {{-- <button class="btn btn-lg btn-info button finish myfinish-2 pull-right myfinish2" type="button" >
                                     ...
                                     <button class="btn btn-info button review review-btn myfinish-2 pull-right myfinish2" type="button" onclick="viewReviewInfo()" style="display: none;">
                                   ...
                                   {{--   <button class="btn btn-lg btn-info button success-btn prev pull-right prev-btn" type="button" >
                                         <i class="fa fa-arrow-left arrow-right-css"></i>
                                        {{ getPhrase('previous')}}
...
@include('student.exams.scripts.js-scripts-st-2',['quiz_record'=>$quiz,'section_timings'=>$section_timings])
...
<script type="text/javascript">
    ...
    showSubjectQuestion('subject_{{$sections[0]}}','{{$section_names[0]}}');
     ...
     intilizetimer({{ (int)$section_timings[0]['hrs'] }},{{ (int)$section_timings[0]['minutes'] }},1);
