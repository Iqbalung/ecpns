			...
			<div class="container-fluid">
				...
				<div class="panel panel-custom col-lg-10 col-lg-offset-1">
					...
					{!! Form::open(array('url' => URL_SETTINGS_ADD_SUBSETTINGS.$record->slug, 'method' => 'PATCH',
						...
						@if( $record->slug === 'email-settings')
						{!! Form::open(array('route' => ['mastersettings.smtp_test'], 'method' => 'POST',
						'novalidate'=>'','name'=>'formSettingsEmail')) !!}
							<div class="row padding-10">
								<div class="col-lg-6">
									<input type="email" name="email" id="email" value="{{\Auth::user()->email}}" class="form-control"></div>
								<div class="col-lg-6">
									<input type="submit" name="send_email" value="{{getPhrase('Send Test Email')}}" class="btn btn-lg btn-info button">
								</div>
							</div>
						</form>
						@endif
