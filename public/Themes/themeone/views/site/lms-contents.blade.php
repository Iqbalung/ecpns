...
<style>
  ...
  <!-- Page Banner -->
    <section class="cs-primary-bg cs-page-banner bnmt" >
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    @if($lms_series)
                    ...
                    <div class="info-box ribbon_box same_height">
                     ...
                     <div class="cs-info-box-bordered btm30 cs-animate">
                        ...
                        <div class="cs-icon color-teal">
                            @if($content->image) 
                            <img src="{{IMAGE_PATH_UPLOAD_LMS_CONTENTS.$content->image}}" class="wid-hun">
                            @else
                             <img src="{{IMAGE_PATH_EXAMS_DEFAULT}}" class="wid-hun">
                            @endif
                        </div>
