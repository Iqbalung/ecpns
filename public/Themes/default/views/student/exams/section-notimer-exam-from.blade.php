                            ...
                            <span class="text-uppercase title-heading cf-tithead">
                             ...
                             <?php $section_data  = (array)json_decode($quiz->section_data); ?>
                              ...
                              @foreach($section_data as $key=>$value)
                                ...
                                <span id="{{$key}}" class="question-sections margin-mr">
...
<!--   <i class="mdi mdi-printer"></i>  -->
  {{getPhrase('question')}}
                    ...
                    <div class="flag-details" >
                     ...
                     <span class="positive next review-next" id="markbtn" class="cf-poshead" type="button">
...
@include('student.exams.scripts.js-scripts-snt-2')
