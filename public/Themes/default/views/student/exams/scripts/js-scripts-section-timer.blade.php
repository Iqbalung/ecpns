...
$scope.refreshContent = function(className) {
           ...
           $.getScript( "{{JS}}4.5.8/standard-all/ckeditor.js", function( data, textStatus, jqxhr ) {
        $(className).each(function(){
            CKEDITOR.replace(this, {
            extraPlugins: 'mathjax',
            mathJaxLib: '{{JS}}2.6-latest/MathJax.js',
            height: 320
            });
        ...
        $.getScript("{{JS}}2.7.1/MathJax.js", function( data, textStatus, jqxhr ) {
