                    ...
                    <div class="col-md-12 st-majorr">
                        <nav class="portfolio-filter text-center">
                            ...
                            <ul class="list-inline">
                                ...
                                ?>
                                <li><a class="btn btn-default st-mocks" data-toggle="tooltip" data-placement="top" title="" href="#" data-filter=".cat{{$i++}}" data-original-title="{{$quizzes->count()}}">{{$category->category}}</a></li>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @if ($quiz->is_paid)
                                                        <a type="button" class="btn btn-success btn-xs exa-br" href="{{ URL_START_EXAM_AFTER_LOGIN.$quiz->id }}" >Take Exam</a>
                                                    @else
                                                        <a type="button" class="btn btn-success btn-xs exa-br" href="{{URL_FRONTEND_START_EXAM.$quiz->slug}}" >Take Exam</a>
                                                    @endif
