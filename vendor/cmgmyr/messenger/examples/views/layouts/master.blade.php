...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="{{JS}}/bootstrap/3.3.6/bootstrap.min.css" crossorigin="anonymous">
...
<script src="{{JS}}bootstrap/3.3.6/bootstrap.min.js"  crossorigin="anonymous"></script>
</body>
</html>