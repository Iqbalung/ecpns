...
Route::post('exams/questionbank/import', 'ImportExcelController@import');
...
Route::post('payments/subscribe', 'PaymentsController@selectCustomPackage')->name('payments.select_custom');
Route::get('payments/view-invoice/{invoice_id}', 'PaymentsController@viewInvoice')->name('payments.view_invoice');
...
//Packages Module
Route::get('packages/list', 'PackagesController@index');
Route::get('packages/getList/{slug?}', 'PackagesController@getDatatable');
Route::get('packages/add', 'PackagesController@create');
Route::post('packages/add', 'PackagesController@store');
Route::get('packages/edit/{slug}', 'PackagesController@edit');
Route::patch('packages/edit/{slug}', 'PackagesController@update');
Route::delete('packages/delete/{slug}', 'PackagesController@delete');
