                   ...
                   <h4 class="text-center login-head">{{getPhrase('create_account')}}</h4>
                    <!-- Form Login/Register -->
                        ...
                        <div class="form-group">
                        	...
                        	<label for="name">{{getPhrase('name')}}</label><span class="cf-color">*</span>
                        ...
                        <div class="form-group">
                          ...
                          <label for="username">{{getPhrase('username')}}</label><span class="cf-color">*</span>
						...
						<div class="validation-error" ng-messages="registrationForm.username.$error" >
                         ...
                         <div class="form-group">
                          ...
                          <label for="email">{{getPhrase('email')}}</label><span class="cf-color">*</span>
                        ...
                        {{ Form::email('email', $value = null , $attributes = array('class'=>'form-control',
                          ...
                          <label for="password">{{getPhrase('password')}}</label><span class="cf-color">*</span>
                       ...
                       <label for="password_confirmation">{{getPhrase('password_confirmation')}}</label><span class="cf-color">*</span>
                       ...
                       {{ Form::password('password_confirmation', $attributes = array('class'=>'form-control instruction-call',
						...
						<input type="hidden" name="is_student" value="0">
                         ...
                         <div class="form-group">
				          ...
				          <div class="col-md-12 form-group{{ $errors->has('g-recaptcha-response') ? ' has-error' : '' }} cf-mtp" >
