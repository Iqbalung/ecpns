				...
				<div class="vertical-scroll" >
								  ...
								  <tr>
									...
									<tbody>
										...
										<td><a ng-click="removeQuestion(i)"  class="btn-outline btn-close text-red cpsty"><i class="fa fa-close"></i></a></td>
								  ...
								  <tr>
									...
									<tbody>
										...
										<td ng-if="is_have_section==0"><a ng-click="removeQuestion(j)"  class="btn-outline btn-close text-red cpsty"><i class="fa fa-close"></i></a></td>
										
										<td ng-if="is_have_section==1"><a ng-click="removeQuestionWithKey(j, key)"  class="btn-outline btn-close text-red cpsty"><i class="fa fa-close"></i></a></td>
