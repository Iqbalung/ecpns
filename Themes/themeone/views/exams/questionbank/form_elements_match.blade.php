...
<div ng-if="question_type=='match'">
    ...
    <fieldset class="form-group col-md-5" >
        ...
        <textarea name="options_left[]" id="option_@{{ $index }}" class="form-control" placeholder="Option @{{ $index+1 }}" ng-model="answers.left.options[$index]"  min="1"  required="true" ckeditor></textarea>
        @else
    ...
    <fieldset class="form-group col-md-5" >
        ...
        @if(env('ENABLE_OPTIONS_EDITOR'))
        <textarea name="options_right[]" id="option_@{{ $index }}" class="form-control" placeholder="Option @{{ $index+1 }}" ng-model="answers.right.options[$index]"  min="1"  required="true" ckeditor></textarea>
        @else
    ...
    <fieldset class="form-group col-md-2" >
        ...
        @if(env('ENABLE_OPTIONS_EDITOR'))
        <textarea name="correct_answers[]" id="option_@{{ $index }}" class="form-control" placeholder="@{{ $index+1 }}" ng-model="correct_answers[$index].answer"  min="1"  required="true" ckeditor></textarea>
        @else
   ...
   <h4>For 2nd Language</h4>
    ...
    <fieldset class="form-group col-md-5" >
        ...
        @if(env('ENABLE_OPTIONS_EDITOR'))
        <textarea name="optionsl2_left[]" id="optionl2_@{{ $index }}" class="form-control" placeholder="Option 2nd lang @{{ $index+1 }}" ng-model="answers.left.optionsl2[$index]"  min="1" ckeditor></textarea>
        @else
    ...
    <fieldset class="form-group col-md-5" >
        ...
        @if(env('ENABLE_OPTIONS_EDITOR'))
        <textarea name="optionsl2_right[]" id="optionl2_@{{ $index }}" class="form-control" placeholder="Option 2nd lang @{{ $index+1 }}" ng-model="answers.right.optionsl2[$index]"  min="1" ckeditor></textarea>
        @else
