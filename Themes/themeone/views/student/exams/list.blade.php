                ...
                <div class="panel-body packages">
                    <div>
                        ...
                        @else
                            ...
                            <a
                                href="{{ URL_USERS_SETTINGS . Auth::user()->slug }}">{{ getPhrase('click_here_to_change_your_preferences') }}</a>
                        @endif
                    </div>
    ...
    @if ($interested_categories)
        @if ($category)
            @include('common.datatables', [
                'route' => URL_STUDENT_QUIZ_GETLIST . $category->slug,
                'route_as_url' => true,
            ])
        @else
            @include('common.datatables', [
                'route' => URL_STUDENT_QUIZ_GETLIST_ALL,
                'route_as_url' => true,
            ])
        @endif
        @include('common.deletescript', ['route' => URL_QUIZ_DELETE])
    @endif
    <script>
