...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 para-left-panel para-main-content">
            ...
            <div class="para-main-question questions questions-paralist">  
               ...
               <span class="language_l1 lan-crb"> {!! $question->question !!}  </span>
                       ...
                       <span class="language_l2 lan-crbdn" > {!! $question->question_l2 !!}   </span>

                       @else

                       <span class="language_l2 lan-crbdn" > {!! $question->question !!}   </span>

                         @endif

                       @else

                       <span class="language_l2" > {!! $question->question !!}   </span>
            ...
            <div class="question_para"  style="display:none;" >
                ...
                <div class="question">
                    ...
                    <p>
                       ...
                       {{--  Q{{$q++}}) --}} <span class="language_l1 lan-crb" >{!!$answer->question !!}</span>

                       

                        <span class="language_l2 lan-crbdn" >{!!$answer->question !!}</span>
                       ...
                       @if(isset($answer->has_file))
                        ...
                        <img src="{{$image_path.$answer->file_name}}"  class="crb-mt">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-12">
                            ...
                            <label for="{{$question->id.'_'.$i.'_'.$index}}">
                                ...
                                <span class="language_l1 crb-mtcb" >{!!$value1!!}</span>
                            ...
                            @if( $option_img )
                                 ...
                                 ?>
                                   ...
                                   @if( $temp2 )
                                       ...
                                       <img src="{{ $image_path.$temp2['file_name'] }}" class="choice-img crb-mt"  >
                            ...
                            @endif
                                ...
                                <span class="language_l2 lan-crbdn" >{!! $value1 !!}</span>
