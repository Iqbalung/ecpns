    ...
    <div class="container-fluid cf-main">
                            ...
                            <span class="text-uppercase title-heading cf-span-headone">
                             ...
                             <?php $section_data  = (array)json_decode($quiz->section_data); ?>
                              ...
                              @foreach($section_data as $key=>$value)
                                ...
                                <span id="{{$key}}"  class="question-sections qsme">
        ...
        <div id="timerdiv" class="countdown-styled timer-style">
          <span class="remaining">
            <i class="mdi mdi-timer yellow-templateimg" ></i>
          Time Remaining
           </span>
...
<!--   <i class="mdi mdi-printer"></i>  -->
  {{getPhrase('question')}}
                    ...
                    <div class="flag-details" >
                     ...
                     <span class="positive next review-next yellow-template-tar" id="markbtn"  type="button">
                            ...
                            <div class="row max ">
                                ...
                                <div class="col-md-12">
                                   ...
                                   <button class="btn btn-lg btn-info button success-btn next" type="button" >
                                       ...
                                       <i class="fa fa-arrow-right y-template-fw"></i>
                                    </button>
                                    ...
                                    <button class="btn btn-lg btn-info button paranext nextpara para-next" type="button" >
                                     ...
                                     <button class="btn btn-info button review review-btn myfinish-2 pull-right fin-sty" type="button" onclick="viewReviewInfo()" >
                                     ...
                                     <button class="btn btn-lg btn-info button success-btn prev pull-right prev-btn" type="button" >
                                         <i class="fa fa-arrow-left y-template-fw"></i>
                                        {{ getPhrase('previous')}}
