    ...
    <div class="container-fluid cf-sty">
        ...
        <div id="timerdiv" class="countdown-styled timer-style">
          ...
          Time Remaining
            ...
            <span id="hours" class="cf-stytime">{{ $time_hours}}</span> :
            <span id="mins" class="cf-stytime">{{ $time_minutes}}</span> :
            <span id="seconds" class="cf-stytime">00</span>
...
<!--   <i class="mdi mdi-printer"></i>  -->
  {{getPhrase('question')}}
                    ...
                    <div class="flag-details" >
                     ...
                     <span class="positive next review-next cf-positivenxt" id="markbtn"  type="button">
