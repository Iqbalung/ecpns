...
.cal-timer{
  margin-right:2px;font-size:15px !important;
}
.calcfit{
...
<div id="page-wrapper" class="examform" ng-controller="angExamScript"  ng-init="initAngData({{json_encode($bookmarks)}})">
    ...
    <div class="container-fluid cf-sty">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-custom custom-panel">
                    ...
                    <div class="panel-heading heading-panel cf-styphead">
                        ...
                        <h1 class="cf-headone">
                            ...
                            <span class="text-uppercase title-heading cf-tithead">
        ...
        <div id="timerdiv" class="countdown-styled timer-style">
          <span class="remaining">
            <i class="mdi mdi-timer cal-timer" ></i> 
...
<!--   <i class="mdi mdi-printer"></i>  -->
  {{getPhrase('question')}}
                    ...
                    <div class="flag-details" >
                     ...
                     <span class="positive next review-next cf-poshead" id="markbtn" type="button">
                            ...
                            <div class="row max ">
                                ...
                                <div class="col-md-12">
                                   ...
                                   <button class="btn btn-lg btn-info button success-btn next" type="button" >
                                       ...
                                       <i class="fa fa-arrow-right calcarrow"></i>
                                    </button>
                                    ...
                                    <button class="btn btn-lg btn-info button paranext nextpara para-next" type="button" >
                                     ...
                                     <button class="btn btn-info button review review-btn myfinish-2 pull-right cpstyone" type="button" onclick="viewReviewInfo()" >
                                   ...
                                   {{--   <button class="btn btn-lg btn-info button success-btn prev pull-right prev-btn" type="button" >
                                         <i class="fa fa-arrow-left calcarrow"></i>
                                        {{ getPhrase('previous')}}
