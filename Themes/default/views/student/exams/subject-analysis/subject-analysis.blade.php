			...
			<div class="container-fluid">
				...
				<div class="panel panel-custom">
					...
					<ul class="nav nav-tabs add-student-tabs">
							...
							<li><a data-toggle="tab" href="#strong_weak">{{getPhrase('strong_vs_weak')}}</a></li>
...
@if(isset($strongweak_data))

	@include('common.chart', array('chart_data'=>$strongweak_data,'ids' => $strongweakids));
