...
<link href="{{CSS}}zencdn/5.10.4/video-js.css" rel="stylesheet">

 <script src="{{JS}}zencdn/1.1.2/videojs-ie8.min.js"></script>
@stop
...
@section('footer_scripts')
 <script src="{{JS}}zencdn/5.10.4/video.js"></script>
