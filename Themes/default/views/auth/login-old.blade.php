    ...
    {!! getValidationMessage('password')!!}
        ...
        <div class="input-group">
              ...
              <div class="col-md-12 form-group{{ $errors->has('g-recaptcha-response') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 pull-center pull-centerml">
                                {!! app('captcha')->display() !!}
      ...
      <div class="text-center buttons">
        ...
        <button type="submit" class="btn button btn-success btn-lg centermtop" ng-disabled='!loginForm.$valid' >{{getPhrase('login')}}</button>
