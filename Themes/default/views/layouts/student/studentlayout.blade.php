		...
		<aside class="left-sidebar">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<ul class="nav navbar-nav side-nav {{$block_class}}">
					...
					<li {{ isActive($active_class, 'resume') }} >

                    <a href="{{URL_USER_BUILD_RESUME.Auth::user()->slug}}"><i class="fa fa-file-image-o fa-2x" aria-hidden="true"></i>
					{{ getPhrase('build_resume') }} </a>
