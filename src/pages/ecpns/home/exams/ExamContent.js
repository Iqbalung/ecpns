...
export default function ExamContent({ wrapperClass, itemClass }) {
          ...
          <div className={`service-card service-card-8 ${data.shape}`}>
            <div className="inner">
              <div className="icon">
                <a href={data.link}>
                  <img
                    src={`${process.env.PUBLIC_URL}./images/category/category-04/${data.image}`}
                    alt="Category Thumb"
                  />
                </a>
              </div>
              ...
              <div className="hover-action">
                <a className="read-more-btn" href={data.link}>
