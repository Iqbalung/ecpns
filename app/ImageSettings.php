...
class ImageSettings extends Model
{
    ...
    */
    ...
    {
        return $this->prefix . $this->thumbnailSize;
    }
    ...
    {
        return $this->prefix . $this->profilePicSize;
    }
    ...
    {
        return $this->prefix . $this->examImageSize;
    }

    public function getExamMaxFilesize()
    {
        return $this->prefix . $this->examMaxFileSize;
    }
    ...
    {
        return $this->prefix . $this->blogThumbnailSize;
    }
