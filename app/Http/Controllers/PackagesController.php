...
class PackagesController extends Controller
{
    ...
    public function index()
    {
        ...
        $view_name = getTheme().'::packages.list';
    ...
    public function getDatatable($slug = '')
    {
        ...
        $records = Package::select(['name', 'validity', 'amount', 'status', 'slug', 'validity_type'])
                        ->where('type', 'main')
        ...
        ->addColumn('action', function ($records) {
          ...
          $link_data = '<div class="dropdown more">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dLabel">
                            <li><a href="'.URL_PACKAGES_EDIT.$records->slug.'"><i class="fa fa-pencil"></i>'.getPhrase("edit").'</a></li>';
        ...
        {
            return $records->validity . ' ' . str_plural($records->validity_type, $records->validity);
        })
        ...
        {
            return getCurrencyCode() . ' ' . $records->amount;
        })
        ->removeColumn('slug')
    ...
    public function create()
    {
    	...
    	$data['title']              = getPhrase('create_page');
         $view_name = getTheme().'::packages.add-edit';
        return view($view_name, $data);
    }
