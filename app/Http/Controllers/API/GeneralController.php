...
class GeneralController extends Controller
{
    ...
    public function examCategories(Request $request)
    {
        ...
        if (!$user_id) {
            $response['categories']  = \App\QuizCategory::all();
        ...
        if ($interested_categories) {
            if (count($interested_categories->quiz_categories)) {
                $response['categories']         = \App\QuizCategory::whereIn('id', (array) $interested_categories->quiz_categories)->get();
            }
        }
    ...
    public function lmsCategories(Request $request)
    {
        ...
        if ($interested_categories) {
            if (count($interested_categories->lms_categories)) {
                $response['categories']       = \App\LmsCategory::whereIn('id', (array) $interested_categories->lms_categories)
                                              ->get();
            }
        }
