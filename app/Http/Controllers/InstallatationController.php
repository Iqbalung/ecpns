...
class InstallatationController extends Controller
{
  ...
  /** NullJungle.com
    ...
    public function reg()
    {
        ...
        if ( $users_count > 1 ) {
          $flash = app('App\Http\Flash');
          $flash->create('Danger...!', 'You have already crearted primary user', 'error', 'flash_overlay',FALSE);
          return redirect(PREFIX);
        }
    ...
    public function registerUser(Request $request)
    {
        $columns = array(
            ...
            'owner_password' => 'bail|required|min:5',
        );
        ...
        $user = User::where('email', 'owner@owner.com')->first();
  ...
  function createTables(Request $request)
  {
    ...
    else
    {
      ...
      $query = str_replace('http://phpstack-127383-482309.cloudwaysapps.com/', PREFIX, $query);
