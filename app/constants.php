...
define('DOWNLOAD_EMPTY_DATA_DATABASE', PREFIX1.'public/downloads/database/install.sql');
define('DOWNLOAD_SAMPLE_DATA_DATABASE', PREFIX1.'public/downloads/database/install_dummy_data.sql');
...
define('URL_TWITTER_LOGIN', PREFIX.'auth/twitter');
...
//Front end Practice Exams
define('URL_START_EXAM_AFTER_LOGIN', PREFIX.'take-exam/');
//Feedback
define('URL_FEEDBACK_STATUS', PREFIX.'feedback/status/');
...
define('URL_PACKAGES_GETLIST', PREFIX.'packages/getList');
...
//BLOGS
define('URL_BLOGS', PREFIX.'blogs/list');
define('URL_BLOGS_ADD', PREFIX.'blogs/add');
define('URL_BLOGS_EDIT', PREFIX.'blogs/edit/');
define('URL_BLOGS_DELETE', PREFIX.'blogs/delete/');
define('URL_BLOGS_GETLIST', PREFIX.'blogs/getList');


//FRONT BLOGS
define('URL_HOME_BLOGS', PREFIX.'blogs');
define('URL_BLOG_VIEW', PREFIX.'blog/');


//RESUME TEMPLATES MODULE
define('URL_RESUME_TEMPLATES', PREFIX.'resume/templates');
define('URL_RESUME_TEMPLATES_ADD', PREFIX.'resume/templates/add');
define('URL_RESUME_TEMPLATES_EDIT', PREFIX.'resume/templates/edit');
define('URL_RESUME_TEMPLATES_DELETE', PREFIX.'resume/templates/delete/');
define('URL_GET_RESUME_TEMPLATE', PREFIX.'resume/get-template/');

define('RESUME_TEMPLATE_IMG_PATH', UPLOADS.'resumes/');

define('URL_USER_BUILD_RESUME', PREFIX.'resume/build-resume/');
define('URL_GET_USER_RESUME_DATA', PREFIX.'resume/get-user-resume-data');
define('URL_VIEW_USER_RESUME', PREFIX.'users/view-resume/');

define('URL_ADD_RESUME_BUILDER_FEATURE', PREFIX.'add/resume-builder-plugin');


//Web services
//FCM NOTIFICAION SEND
define('URL_FCM_NOTIFICATION', PREFIX.'send-notification');
