 ...
 <div class="row">
    <div class="col-lg-12" class="contact-uscol12">
	  <h5 class="text-center" class="contact-ustc">Forgot Password</h5>
	</div>
  </div>
   ...
   <div class="row">
	...
	<p class="contact-us-para">Your Forgot Password Request Is Received Successfully. The New Credentials Are</p>
  
  <p class="contact-us-para">Username / Email : {{$username}} / {{$email}}</p>
  <p class="contact-us-para">Password : {{$password}}</p>
