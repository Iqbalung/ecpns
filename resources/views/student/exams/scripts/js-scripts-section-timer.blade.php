...
$scope.refreshContent = function(className) {
           ...
           $.getScript( "{{JS}}plugins/ckeditor/ckeditor.js", function( data, textStatus, jqxhr ) {
        $(className).each(function(){  
            CKEDITOR.replace(this, {
            extraPlugins: 'mathjax',
            mathJaxLib: '{{JS}}plugins/ckeditor/plugins/mathjax/two-latest/MathJax.js',
            height: 320
            });
        ...
        $.getScript("{{JS}}plugins/ckeditor/plugins/mathjax/latest/mathseven.js", function( data, textStatus, jqxhr ) {
...
function nextClick(argument) {
   ...
   processNext(is_marked);
    ...
    if(!next_div.hasClass('subject_'+current_section_key)) {
     ...
     next_div.slideDown(DURATION).prev().hide();
